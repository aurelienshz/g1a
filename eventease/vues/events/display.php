		...
		<div class="previous_comments">
			<div class="comment">
                <?php
                    ...
                    {
                    ?><p><img src="<?php echo $commentaire['picture']; ?>"/><a href="<?php echo getLink(['membres','profil',$commentaire[4]]); ?>" target="_blank"><?php echo ' ' . $commentaire[0]; ?></a> <?php echo $commentaire[2];?></br><input value="Modifier" type="submit" id="Modifier"/><input value="Supprimer" type="submit" id="Supprimer"/></p>
