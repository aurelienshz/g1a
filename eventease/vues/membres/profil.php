    ...
    <div class="page_container">
        ...
        <div class="col_gauche">
            <div class="photo_profil">
                <img id="ph_prf" alt="Nom du profil" src="<?php echo IMAGES.'pirate-cat.jpg'; ?>" title="Nom du profil" height="230" width="230"/>
            </div>
...
<?php /* <div class="wrapper">
    <div class="page_container">
        ...
        <div class="col_gauche">
            <div class="photo_profil">
                <img id="ph_prf" alt="Nom du profil" src="" title="Nom du profil" height="230" width="230"/>
            </div>
            <ul class="interaction_profil">
                <li><a href="#">Inviter à un évènement</a></li>
                <li><a href="#">Suivre cette personne</a></li>
